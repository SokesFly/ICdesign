...
reset_design
#时钟周期3ns
create_clock -period 3.0 [get_ports wr_clk_i]
#系统时钟到输入端口clk时钟的延迟 
...
#时钟的转换时间0.12ns
set_clock_transition 0.12 [get_clocks wr_clk_i]

create_clock -period 9.0 [get_ports rd_clk_i]
...
set_clock_transition 0.12 [get_clocks rd_clk_i]
